...
export default function OrderDetailModal({ order, onClose }: OrderDetailModalProps) {
    ...
    // Render modal as a portal for full-page overlay
    return createPortal(
        <div
        ...
        >
            <div
                className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl p-8 w-full max-w-xl mt-10 md:mt-0 relative border border-blue-100"
                    ...
                    <>
                        {order.giftCard.imageUrl && (
                            <img
                                ...
                                className="w-32 h-32 object-contain mx-auto mb-4 rounded-xl bg-gray-100 p-2"
                            />
                        )}
